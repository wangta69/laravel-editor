...
<div id="pop_wrap">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="/plugins/editor/smart-editor/photo_uploader/img/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="/plugins/editor/smart-editor/photo_uploader/img/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
...
.pop_container .drag_area .bg{display:block;position:absolute;top:0;left:0;width:341px;height:129px;background:#fdfdfd url(/plugins/editor/smart-editor/photo_uploader/img/bg_drag_image.png) 0 0 no-repeat}
