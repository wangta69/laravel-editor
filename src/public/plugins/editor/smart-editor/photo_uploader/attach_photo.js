...
function goStartMode(){
  ...
  if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    welBtnConfirm.attr("src","/plugins/editor/smart-editor/photo_uploader/img/btn_confirm2.png");
...
function goReadyMode(){
  ...
  if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
    ...
    welBtnConfirm.attr("src","/plugins/editor/smart-editor/photo_uploader/img/btn_confirm.png");
  }
}   
...
function addImage(ofile){
  ...
  if( !!bExceedLimitTotalSize ){
    ...
    aFileList.push('  <em>'+ sFileSize +'</em>');
          aFileList.push('  <a onclick="delImage(\'img'+nImageInfoCnt+'\')"><img class="del_button" src="/plugins/editor/smart-editor/photo_uploader/img/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
    aFileList.push('  </li> ');   
...
function callAjaxForHTML5 (tempFile, sUploadURL){
  ...
  oAjax.header("X-CSRF-TOKEN",csrfToken[0].content);
